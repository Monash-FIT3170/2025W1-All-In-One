...
async function loadRouteModule(route, routeModulesCache) {
  ...
  try {
    let routeModule = await module.dynamicImport(
      /* @vite-ignore */
      /* webpackIgnore: true */
      route.module
    );
    ...
    if (routeModule) {
      ...
      dataRoute.lazy = {
        loader: route.hasClientLoader ? async () => {
          let { clientLoader } = route.clientLoaderModule ? await module.dynamicImport(
            /* @vite-ignore */
            /* webpackIgnore: true */
        ...
        action: route.hasClientAction ? async () => {
          let clientActionPromise = route.clientActionModule ? module.dynamicImport(
            /* @vite-ignore */
            /* webpackIgnore: true */
        ...
        unstable_middleware: route.hasClientMiddleware ? async () => {
          let { unstable_clientMiddleware } = route.clientMiddlewareModule ? await module.dynamicImport(
            /* @vite-ignore */
            /* webpackIgnore: true */
