...
Meteor.methods({
  ...
  async "addProperty" ({propAddress, pricePerWeek, numBeds, numBaths, numParkSpots, propType, description, isFurnished, petsAllowed, bond, landlordEmail, status, agentId}) {
    try {
