...
export const Ten_SettingsEmployment = new Mongo.Collection(
...
export const Ten_SettingsAddresses = new Mongo.Collection(
...
export const Ten_SettingsIdentities = new Mongo.Collection(
...
export const ExpressionOfInterest = new Mongo.Collection(
