                        ...
                        return (
                            <div key={app._id} className="flex overflow-hidden gap-8">
                                ...
                                <div className="w-3/4 p-8 bg-[#CBADD8] rounded-2xl flex flex-col justify-between">
                                    ...
                                    <div className="mt-4 bg-white bg-opacity-80 rounded p-3 max-h-32 overflow-y-auto divide-y divide-gray-300 text-gray-800">
                                        <h4 className="font-semibold mb-2">Possible Shared Leaseholders:</h4>
                                        
                                        <div className="mt-4 bg-white bg-opacity-80 rounded p-3 max-h-32 overflow-y-auto divide-y divide-gray-300 text-gray-800">
                                            {app.tenants.map(t => (
                                            <div key={t.ten_id} className="py-1">
                                                {t.ten_fn} {t.ten_ln}
                                            </div>
                                            ))}
                                        </div>
