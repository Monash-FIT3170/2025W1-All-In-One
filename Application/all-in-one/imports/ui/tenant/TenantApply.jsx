...
import { RentalApplications } from "../../api/database/collections";
...
function Apply() {
  ...
  //Grab status from db
  const { application, subReady } = useTracker(() => {
    const sub = Meteor.subscribe("rentalApplications");
    const application = RentalApplications.findOne({
      ten_id: "T002",
      prop_id: "P002",
      // ten_id: tenantId,
      // prop_id: id,
    });
    return { application, subReady: sub.ready() };
  });
                ...
                <div
                  ...
                  className={`p-3 mb-2 rounded-md font-semibold cursor-pointer ${
                    item === activeSection
                      ...
                      : "bg-transparent text-black hover:bg-violet-900 hover:text-white"
                  }`}
                >
                  {item}
                </div>
            ...
            <div className="flex-1 bg-gray-50 p-6 rounded-lg shadow">
              ...
              <div className="flex justify-between mt-8">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-[#9747FF] text-white  font-semibold rounded disabled:opacity-50 hover:bg-violet-900 hover:text-white"
                >
                  Next
                </button>
              </div>
